...
export default function Footer() {
      return (
            <>
                  <footer className='flex flex-col md:flex-row md:justify-between space-y-8 bg-purple-900 text-white py-5 px-5'>
                        <div>
                              <div className='left'>
                              ...
                              <div className='mid'>
                                    <div className='cursor-pointer  primaryText'>Northeast elecrtonics hub</div>
                                    <p>High quality is our first priority</p>
                                    <p>Copyright 2027 &copy;  Northeast elecrtonics hub</p>
